...
def handleRemoveReadonly(func, path, exc):
  ...
  if func in (os.rmdir, os.remove) and excvalue.errno == errno.EACCES:
      ...
      raise IOError("Could not save model; Something went wrong!")
...
class DataSaver:
    ...
    def __init__(self, config, run_number = None, run_name = None):
        ...
        if run_name is None:   
            self.run_name = self.config["output"]["run_name"]
        else:
