...
compute_mvpp <- function(file_name, parallelization)
{
...
type                <- "toy" # "kis" # "laef"
trainingDays        <- 365
observation_columns <- c("W0", "W1") #c("obs") #c("T_DEWP_10", "T_DRYB_10") #  c("W0", "W1")
ensemble_regex      <- c("^Model_W0_", "^Model_W1_") # c("^laef") # c("^IFS_x2d_", "^IFS_x2t_") # c("^Model_W0_", "^Model_W1_")
trainingWindow      <- 30
